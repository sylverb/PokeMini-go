...
int MinxLCD_LoadStateStream(memstream_t *stream, uint32_t bsize)
{
	...
	POKELOADSS_STREAM_A(LCDData, 256*9);
	POKELOADSS_STREAM_A(LCDPixelsD, 96*64);
	POKELOADSS_STREAM_A(LCDPixelsA, 96*64);
	POKELOADSS_STREAM_32(MinxLCD.Pixel0Intensity);
	POKELOADSS_STREAM_32(MinxLCD.Pixel1Intensity);
	POKELOADSS_STREAM_8(MinxLCD.Column);
	POKELOADSS_STREAM_8(MinxLCD.StartLine);
	POKELOADSS_STREAM_8(MinxLCD.SetContrast);
	POKELOADSS_STREAM_8(MinxLCD.Contrast);
	POKELOADSS_STREAM_8(MinxLCD.SegmentDir);
	POKELOADSS_STREAM_8(MinxLCD.MaxContrast);
	POKELOADSS_STREAM_8(MinxLCD.SetAllPix);
	POKELOADSS_STREAM_8(MinxLCD.InvAllPix);
	POKELOADSS_STREAM_8(MinxLCD.DisplayOn);
	POKELOADSS_STREAM_8(MinxLCD.Page);
	POKELOADSS_STREAM_8(MinxLCD.RowOrder);
	POKELOADSS_STREAM_8(MinxLCD.ReadModifyMode);
	POKELOADSS_STREAM_8(MinxLCD.RequireDummyR);
...
{
	POKESAVESS_STREAM_START(256*9 + 96*64 + 96*64 + 64);
	POKESAVESS_STREAM_A(LCDData, 256*9);
	POKESAVESS_STREAM_A(LCDPixelsD, 96*64);
	POKESAVESS_STREAM_A(LCDPixelsA, 96*64);
	POKESAVESS_STREAM_32(MinxLCD.Pixel0Intensity);
	POKESAVESS_STREAM_32(MinxLCD.Pixel1Intensity);
	POKESAVESS_STREAM_8(MinxLCD.Column);
	POKESAVESS_STREAM_8(MinxLCD.StartLine);
	POKESAVESS_STREAM_8(MinxLCD.SetContrast);
	POKESAVESS_STREAM_8(MinxLCD.Contrast);
	POKESAVESS_STREAM_8(MinxLCD.SegmentDir);
	POKESAVESS_STREAM_8(MinxLCD.MaxContrast);
	POKESAVESS_STREAM_8(MinxLCD.SetAllPix);
	POKESAVESS_STREAM_8(MinxLCD.InvAllPix);
	POKESAVESS_STREAM_8(MinxLCD.DisplayOn);
	POKESAVESS_STREAM_8(MinxLCD.Page);
	POKESAVESS_STREAM_8(MinxLCD.RowOrder);
	POKESAVESS_STREAM_8(MinxLCD.ReadModifyMode);
	POKESAVESS_STREAM_8(MinxLCD.RequireDummyR);
	POKESAVESS_STREAM_8(MinxLCD.RMWColumn);
	POKESAVESS_STREAM_X(42);
