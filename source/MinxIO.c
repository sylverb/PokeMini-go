...
int MinxIO_LoadStateStream(memstream_t *stream, uint32_t bsize)
{
	...
	POKELOADSS_STREAM_8(MinxIO.EEPLastPins);
	POKELOADSS_STREAM_8(MinxIO.ListenState);
	POKELOADSS_STREAM_8(MinxIO.OperState);
	POKELOADSS_STREAM_8(MinxIO.EEPData);
	POKELOADSS_STREAM_32(MinxIO.EEPBit);
	POKELOADSS_STREAM_16(MinxIO.EEPAddress);
...
{
	POKESAVESS_STREAM_START(32+8192);
	POKESAVESS_STREAM_8(MinxIO.EEPLastPins);
	POKESAVESS_STREAM_8(MinxIO.ListenState);
	POKESAVESS_STREAM_8(MinxIO.OperState);
	POKESAVESS_STREAM_8(MinxIO.EEPData);
	POKESAVESS_STREAM_32(MinxIO.EEPBit);
	POKESAVESS_STREAM_16(MinxIO.EEPAddress);
	POKESAVESS_STREAM_X(22);
	POKESAVESS_STREAM_A(EEPROM, 8192);
